...
export const Code = Object.freeze({
  ...
  CORRUPT_REQUEST: 5,
  /**
   * The partition's writer stopped — a full volume being the case it was added for. Retrying later
   * can help: the broker tries to bring the writer back once somebody frees space, at most once
   * every few seconds. Retrying in a tight loop cannot. Reads from the same partition work
   * throughout.
   */
