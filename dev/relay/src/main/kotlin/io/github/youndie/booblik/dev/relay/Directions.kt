package io.github.youndie.booblik.dev.relay
...
import io.github.youndie.booblik.dev.common.FileOffsetStore
...
import io.github.youndie.booblik.net.client.checkpointing
...
suspend fun booblikToKafka(
    ...
    KafkaProducer<ByteArray, ByteArray>(properties).use { kafka ->
        BooblikSubscriber(InetSocketAddress(config.brokerHost, config.brokerPort)).use { subscriber ->
            ...
            val saved = store.load(topic, io.github.youndie.booblik.PartitionId(0))
            subscriber
