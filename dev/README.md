...
ровно один потребитель. Чего здесь нет — подхвата партиции **умершего** сервиса; это второй слой
образца (M-102) и он строится протоколом поверх лога, а не фичей брокера
...
Второго слоя — очереди задач с арендой и переразачей (M-102). Он строится поверх этого и требует
отдельного топика заявок; почему это не фича брокера, разобрано в
[research-usecases](../docs/research/research-usecases.md), решения Р11 и Р13.
