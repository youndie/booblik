...
Три слоя, каждый со своим профилем: базовый — веерное чтение, `--profile queue` — очередь задач,
`--profile relay` — мост в Kafka и обратно.
...
## Слой 3: ретранслятор Kafka ↔ booblik
