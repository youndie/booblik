...
**Итог (замер 18.1, числа уточнены в 18.2):** Alpine ради размера, glibc ради сравнимости
с замерами, BellSoft ради сопровождения. 176 МБ против 364 у temurin на Debian (amd64), и ни
одного доустановленного пакета.
