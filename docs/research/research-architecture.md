...
**Следствие 4. M-38 этим стендом не решается.** Zero-copy по замеру 7 не даёт ничего ниже
≈ 1 ГиБ/с, а линк даёт 0,98 ГиБ/с — и то суммарно на четырёх потоках. Стенд стоит ровно на
границе, где эффект должен только начинаться, поэтому любой результат будет неотличим от шума.
...
(APFS) маппинг гуляет в 8,4 раза — то есть разработчик видит худший вариант, чем прод. Откат —
