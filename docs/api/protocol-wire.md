...
>
> Чего в реализации ещё нет: `apiVersion` принимается любой и не проверяется (`UNSUPPORTED_VERSION`
> зарезервирован под M-43), топики и партиции задаются при старте — создавать их протокол
> не умеет.
