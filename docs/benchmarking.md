...
Что остаётся непроверенным: всё «линуксовое» здесь снято в WSL2, где ext4 лежит на виртуальном
диске (§1.12). Задача **M-46** — повторить на настоящем железе. До неё решение опирается на
относительные сравнения внутри одного прогона, а не на абсолютные числа.
---
