...
базами как есть: Alpine — busybox, там нет `useradd`, а у `adduser` другие флаги. Развилка теперь
внутри одного файла, а не в двух: второй `Dockerfile` разошёлся бы с первым на второй же правке.
