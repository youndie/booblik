...
**M-24: на ext4 `msync` — полноценный барьер, а на APFS нет.**
...
**M-26: качели маппинга — тоже macOS.**
...
На ext4 маппинг не гуляет **вовсе** и при этом на 30 % быстрее. Риск 1 — «маппинг деградирует
ступенькой» — на Linux не подтверждается.
